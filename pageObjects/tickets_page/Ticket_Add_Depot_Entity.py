...
class AddTicketDepotEntity:
    ...
    def click_submit_button(self):
        ...
        total_ticket_update_count_depot = int(self.page.inner_text(xpath_total_depot_count_widget).split("/")[-1].strip())
        ...
        if total_ticket_update_count_depot== self.total_ticket_count_depots +1:
            print(f"The depot initial count {self.total_ticket_count_depots+1} is matched with the total ticket depot update count {total_ticket_update_count_depot}")
        else:
            print(
