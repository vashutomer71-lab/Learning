...
from pageObjects.tickets_page.Ticket_Add_Vehicle_Entity import AddTicketVehicleEntity
...
class TestAddTicket:
     ...
     def test_add_ticket(self, setup, login):
         self.page = login
         self.ticket = AddTicketVehicleEntity(self.page)
         ...
         self.ticket.total_ticket_for_vehicle_count_initial()
         ...
         self.ticket.click_vehicle_licence_plate_number_dropdown()
         self.logger.info("****Successfully click on the vehicle licence plate number dropdown****")
         self.ticket.select_vehicle_licence_plate_number_value()
         self.logger.info("*******Select the vehicle licence plate number value successfully******")
