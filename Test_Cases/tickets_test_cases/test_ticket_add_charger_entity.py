...
from pageObjects.tickets_page.Ticket_Add_Charger_Entity import AddTicketChargerEntity
...
class TestAddTicket:
     ...
     def test_add_ticket(self, setup, login):
         self.page = login
         self.ticket = AddTicketChargerEntity(self.page)
         ...
         self.ticket.total_ticket_for_charger_count_initial()
         ...
         self.ticket.click_charge_box_id_dropdown()
         self.logger.info("****Successfully click on the charge box id dropdown****")
         self.ticket.select_charge_box_id_value()
         self.logger.info("*******Select the charge box id value successfully******")
